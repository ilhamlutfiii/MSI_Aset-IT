...
<div class="card shadow mb-4 ml-2 mr-2">
  ...
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary float-left">Daftar Fungsi</h6>
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      <div class="d-flex justify-content-center">
        {{ $bidangs->links('pagination::bootstrap-4') }}
      </div>
      @else
      <h6 class="text-center">Fungsi Kosong!!! Tolong Tambah Fungsi</h6>
      @endif
    </div>
  </div>
</div>
